...
def make_single_figure(lang_df, feature, level='page', out_dir='./', xtitle='', show=True, show_error_y=True):
    fig_lang = go.Figure()
    ...
    fig_lang.write_image(os.path.join(pdf_out_dir, f"{feature}_per_{level}_{xtitle}.pdf"))
    return html_out


def make_wide_figure(feature_by_lang, feature, level='page', out_dir='./',  xtitle='', show=True, show_error_y=True):
    _, _, doc_stats = make_intermediate_features_for_plot(feature_by_lang, feature, level)
...
def make_combined_figure(feature_by_lang, feature, level='page', out_dir='./', show=True):
    lang_df, doc_dfs, _ = make_intermediate_features_for_plot(feature_by_lang, feature, level)
